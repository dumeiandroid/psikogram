...
const KarakterEngine = (() => {
  ...
  const TEMPERAMENTS = {
    A: {
      ...
      description: 'Ekstrovert, antusias, {dan|serta} sosial. {Suka|Senang|Gemar} menjadi pusat perhatian dan membuat orang lain senang.',
      characteristics: [
        'Ceria, optimis, {dan|serta} penuh semangat',
        '{Mudah|Gampang} bergaul {dan|serta} populer',
        '{Suka|Senang|Gemar} berbicara {dan|serta} menghibur',
        'Spontan {dan|serta} kreatif',
        '{Tidak suka|Kurang suka|Enggan} rutinitas yang membosankan',
        'Emosional {dan|serta} ekspresif'
      ],
      strengths: [
        'Komunikator {yang baik|yang mumpuni|yang solid}',
        'Memotivasi orang lain',
        'Mudah beradaptasi',
        'Antusiasme tinggi',
        'Kreatif {dan|serta} inovatif'
      ],
      weaknesses: [
        'Kurang disiplin',
        'Mudah terdistraksi',
        'Tidak detail-oriented',
        '{Terlalu|Kelewat|Kelampauan} banyak bicara',
        '{Sulit|Susah|Berat} menepati janji'
      ],
      careers: ['Sales & Marketing', 'Public Relations', 'Event Organizer', 'Entertainer', 'Presenter', 'Teacher'],
      tips: [
        '{Buat|Susun|Bikin} to-do list untuk tetap fokus',
        '{Latih|Asah|Kembangkan} kedisiplinan {dan|serta} manajemen waktu',
        'Dengarkan lebih banyak, bicara seperlunya',
        'Selesaikan satu tugas sebelum mulai yang baru',
        'Catat janji {dan|serta} komitmen penting'
      ]
    },
    B: {
      name: 'KOLERIS',
      ...
      description: 'Ekstrovert, tegas, {dan|serta} berorientasi pada tujuan. {Suka|Senang|Gemar} memimpin dan mengambil keputusan.',
      characteristics: [
        'Tegas {dan|serta} percaya diri',
        'Berorientasi pada hasil',
        '{Suka|Senang|Gemar} tantangan {dan|serta} kompetisi',
        'Pengambil keputusan yang cepat',
        'Produktif {dan|serta} efisien',
      ...
      weaknesses: [
        ...
        'Kurang sensitif',
        'Tidak sabaran',
        '{Sulit|Susah|Berat} menerima kritik',
        'Workaholic'
      ],
      careers: ['CEO/Manager', 'Entrepreneur', 'Politisi', 'Direktur', 'Pilot', 'Lawyer'],
      tips: [
        '{Latih|Asah|Kembangkan} empati {dan|serta} mendengarkan',
        'Beri apresiasi pada tim',
        'Kontrol kemarahan {dan|serta} ketidaksabaran',
    ...
    C: {
      ...
      description: 'Introvert, analitis, {dan|serta} detail-oriented. {Suka|Senang|Gemar} kesempurnaan dan kedalaman.',
      characteristics: [
        'Perfeksionis {dan|serta} teliti',
        'Berpikir mendalam {dan|serta} analitis',
        'Sensitif {dan|serta} idealis',
        'Loyal {dan|serta} setia',
        '{Suka|Senang|Gemar} keteraturan {dan|serta} struktur',
      ...
      tips: [
        ...
        '{Jangan|Hindari untuk} overthink, ambil action',
        'Fokus pada progress, bukan perfection',
        '{Belajar|Latih diri} menerima kritik konstruktif',
    ...
    D: {
      ...
      description: 'Introvert, tenang, {dan|serta} damai. {Suka|Senang|Gemar} harmoni dan menghindari konflik.',
      characteristics: [
        'Tenang {dan|serta} sabar',
        'Pendamai {dan|serta} diplomatik',
        'Pendengar {yang baik|yang mumpuni|yang solid}',
        'Stabil {dan|serta} konsisten',
        '{Tidak suka|Kurang suka|Enggan} konflik',
        'Santai {dan|serta} easy-going'
      ],
      strengths: [
        'Kemampuan diplomasi',
        'Sabar {dan|serta} tenang',
        'Pendengar {yang baik|yang mumpuni|yang solid}',
        'Konsisten {dan|serta} stabil',
        'Mudah bergaul'
      ],
      weaknesses: [
        'Kurang inisiatif',
        'Terlalu pasif',
        '{Sulit|Susah|Berat} membuat keputusan',
      ...
      tips: [
        ...
        '{Jangan|Hindari untuk} menghindari konflik yang perlu',
        'Tetapkan tujuan yang jelas',
        '{Latih|Asah|Kembangkan} kemampuan decision making',
  ...
  const PERSONALITY_TYPES = {
    EXTROVERT: {
      ...
      description: 'Anda mendapatkan energi dari interaksi sosial {dan|serta} lingkungan eksternal. Anda cenderung outgoing, ekspresif, dan menikmati keramaian.',
      characteristics: [
        'Mendapat energi dari bersosialisasi',
        'Senang menjadi pusat perhatian',
        'Berbicara untuk berpikir (think out loud)',
        '{Memiliki|Mempunyai} banyak teman {dan|serta} kenalan',
        'Berani mengambil risiko sosial',
        'Merasa kesepian saat sendirian terlalu lama',
        '{Suka|Senang|Gemar} bekerja dalam tim',
        'Ekspresif {dan|serta} antusias'
      ],
      strengths: [
        'Komunikasi {yang baik|yang mumpuni|yang solid}',
        'Networking luas',
        '{Mudah|Gampang} beradaptasi sosial',
        'Antusiasme menular',
        'Kolaborasi tim'
      ],
      weaknesses: [],
      ...
      tips: [
        ...
        '{Belajar|Latih diri} menikmati kesendirian',
        'Fokus pada kualitas hubungan, bukan kuantitas',
        '{Latih|Asah|Kembangkan} kemampuan refleksi diri'
      ]
    },
    INTROVERT: {
      name: 'INTROVERT',
      ...
      description: 'Anda mendapatkan energi dari waktu sendiri {dan|serta} refleksi internal. Anda cenderung thoughtful, fokus, dan lebih nyaman dengan interaksi mendalam.',
      characteristics: [
        'Mendapat energi dari waktu sendirian',
        '{Lebih suka|Lebih senang|Lebih memilih} percakapan mendalam daripada small talk',
        'Berpikir sebelum berbicara',
        '{Memiliki|Mempunyai} lingkaran pertemanan kecil tapi dekat',
        'Butuh waktu untuk "recharge" setelah bersosialisasi',
        '{Lebih suka|Lebih senang|Lebih memilih} mengamati daripada menjadi pusat perhatian',
        '{Suka|Senang|Gemar} bekerja mandiri',
        'Reflektif {dan|serta} thoughtful'
      ],
      strengths: [
        'Mendengarkan dengan baik',
        'Pemikiran mendalam',
        'Fokus {dan|serta} konsentrasi tinggi',
        'Kemandirian',
      ...
      tips: [
        ...
        '{Jangan|Hindari untuk} takut untuk speak up saat dibutuhkan',
    ...
    AMBIVERT: {
      ...
      description: 'Anda berada di tengah-tengah spektrum. Anda fleksibel {dan|serta} dapat menyesuaikan diri baik dalam situasi sosial maupun saat sendirian.',
      characteristics: [
        'Fleksibel antara sosial {dan|serta} solitude',
      ...
      tips: [
        ...
        '{Jangan|Hindari untuk} memaksakan diri ke salah satu ekstrem',
        '{Gunakan|Manfaatkan|Pakai} kemampuan adaptasi sebagai kekuatan'
      ]
    }
  };
  ...
  const DECISION_TYPES = {
    THINKING: {
      ...
      description: 'Anda membuat keputusan berdasarkan analisis objektif, logika, {dan|serta} kebenaran. Anda mengutamakan konsistensi dan keadilan dalam pengambilan keputusan.',
      characteristics: [
        'Mengutamakan logika {dan|serta} rasionalitas',
        'Objektif dalam menilai situasi',
        'Fokus pada kebenaran {dan|serta} fakta',
        'Menganalisis pro {dan|serta} kontra',
        'Tegas {dan|serta} direct dalam komunikasi',
        'Menjaga jarak emosional saat memutuskan',
        'Menghargai kompetensi {dan|serta} keahlian',
      ...
      weaknesses: [
        '{Kurang|Belum cukup} sensitif terhadap perasaan',
      ...
      tips: [
        ...
        '{Latih|Asah|Kembangkan} empati {dan|serta} kepekaan terhadap perasaan orang lain',
    ...
    FEELING: {
      ...
      description: 'Anda membuat keputusan berdasarkan nilai-nilai personal, empati, {dan|serta} dampak terhadap orang lain. Anda mengutamakan harmoni dan kesejahteraan dalam pengambilan keputusan.',
      characteristics: [
        'Mengutamakan nilai {dan|serta} empati',
        'Mempertimbangkan dampak terhadap orang lain',
        'Fokus pada harmoni {dan|serta} kesejahteraan',
        'Subjektif berdasarkan nilai personal',
        'Diplomatik dalam komunikasi',
        'Terhubung emosional dengan situasi',
        'Menghargai hubungan {dan|serta} perasaan',
      ...
      weaknesses: [
        'Terlalu subjektif',
        '{Sulit|Susah|Berat} bersikap tegas',
        '{Mudah|Gampang} terpengaruh emosi',
      ...
      tips: [
        '{Jangan|Hindari untuk} takut membuat keputusan sulit',
        '{Latih|Asah|Kembangkan} objektivitas dalam analisis',
        'Tidak semua konflik perlu dihindari',
        'Seimbangkan empati dengan logika',
        '{Belajar|Latih diri} mengatakan "tidak" saat perlu'
      ]
    }
  };
  ...
  const LIFESTYLE_TYPES = {
    JUDGING: {
      ...
      description: 'Anda menyukai struktur, perencanaan, {dan|serta} keputusan yang cepat. Anda merasa nyaman dengan jadwal dan rutinitas yang jelas.',
      characteristics: [
        '{Suka|Senang|Gemar} membuat rencana {dan|serta} jadwal',
        'Terorganisir {dan|serta} tertib',
        'Menyelesaikan tugas lebih awal',
        'Membuat keputusan dengan cepat',
        '{Suka|Senang|Gemar} closure {dan|serta} penyelesaian',
        'Rutinitas yang konsisten',
        'Disiplin {dan|serta} tepat waktu',
        'Goal-oriented'
      ],
      strengths: [
      ...
      tips: [
        '{Belajar|Latih diri} untuk lebih fleksibel',
        'Terima bahwa tidak semua harus sempurna',
        'Beri ruang untuk spontanitas',
        '{Jangan|Hindari untuk} terlalu keras pada diri sendiri',
    ...
    PERCEIVING: {
      ...
      description: 'Anda menyukai fleksibilitas, spontanitas, {dan|serta} pilihan yang terbuka. Anda merasa nyaman dengan ketidakpastian dan perubahan.',
      characteristics: [
        'Fleksibel {dan|serta} adaptif',
        'Spontan {dan|serta} improvisasi',
        '{Suka|Senang|Gemar} menjaga pilihan tetap terbuka',
      ...
      tips: [
        ...
        '{Gunakan|Manfaatkan|Pakai} to-do list sederhana',
