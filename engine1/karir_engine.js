  ...
  const RIASEC_CATEGORIES = [
    {
      ...
      desc: 'Menyukai pekerjaan praktis, hands-on, {dan|serta} teknis. {Lebih suka|Lebih senang|Lebih memilih} bekerja dengan alat, mesin, atau objek fisik daripada berinteraksi dengan orang.',
      careers: ['Teknisi', 'Mekanik', 'Insinyur', 'Arsitek', 'Pilot', 'Petani', 'Atlet']
    },
    {
      id: 'I', name: 'Investigative', color: '#3498db',
      desc: 'Analitis, ingin tahu, {dan|serta} intelektual. Menyukai riset, sains, dan memecahkan masalah kompleks melalui pemikiran kritis.',
      careers: ['Ilmuwan', 'Peneliti', 'Dokter', 'Analis Data', 'Programmer', 'Ahli Kimia', 'Psikolog']
    },
    {
      id: 'A', name: 'Artistic', color: '#9b59b6',
      desc: 'Kreatif, ekspresif, {dan|serta} intuitif. Menyukai pekerjaan yang tidak terstruktur, orisinal, dan memungkinkan ekspresi diri.',
      careers: ['Desainer', 'Musisi', 'Penulis', 'Seniman', 'Fotografer', 'Aktor', 'Animator']
    },
    {
      id: 'S', name: 'Social', color: '#2ecc71',
      desc: 'Ramah, membantu, {dan|serta} empatik. Senang mengajar, merawat, dan bekerja sama dengan orang lain untuk membantu mereka berkembang.',
      careers: ['Guru', 'Perawat', 'Konselor', 'Pekerja Sosial', 'HR Manager', 'Psikolog Klinis', 'Terapis']
    },
    {
      id: 'E', name: 'Enterprising', color: '#f1c40f',
      desc: 'Ambisius, persuasif, {dan|serta} berjiwa pemimpin. Tertarik pada bisnis, politik, dan mempengaruhi atau memimpin orang lain.',
      careers: ['Pengusaha', 'Manajer', 'Sales Executive', 'Lawyer', 'Politisi', 'Marketing Director', 'CEO']
    },
    {
      id: 'C', name: 'Conventional', color: '#95a5a6',
      desc: 'Teratur, teliti, {dan|serta} menyukai data. Senang dengan rutinitas, administrasi, detail, dan aturan yang jelas.',
  ...
  const KEPEMIMPINAN_LEVELS = [
    {
      ...
      description: 'Luar biasa! Anda memiliki jiwa kepemimpinan yang sangat kuat. Anda adalah komunikator yang tegas, dapat diandalkan, {dan|serta} mampu memberikan dampak positif bagi lingkungan sekitar. Orang-orang mempercayai dan mengikuti arahan Anda.',
      characteristics: [
        'Komunikasi yang jelas, tegas, {dan|serta} efektif dalam menyampaikan visi',
        'Kemampuan pengambilan keputusan yang cepat {dan|serta} tepat',
        'Karisma natural yang membuat orang lain tertarik mengikuti',
        'Integritas tinggi {dan|serta} konsisten antara perkataan dan tindakan',
        'Kemampuan memotivasi {dan|serta} menginspirasi tim',
        'Berani mengambil tanggung jawab {dan|serta} risiko yang terukur',
        'Visioner dengan kemampuan melihat gambaran besar',
        'Empati {dan|serta} kepedulian terhadap anggota tim'
      ],
      suggestions: [
    ...
    },
    {
      ...
      description: 'Bagus! Anda memiliki kualitas kepemimpinan {yang baik|yang mumpuni|yang solid}. Anda mampu mendengarkan orang lain {dan|serta} memimpin mereka menuju satu tujuan bersama. Dengan sedikit pengembangan, Anda bisa menjadi pemimpin yang sangat efektif.',
      characteristics: [
        'Kemampuan komunikasi {yang baik|yang mumpuni|yang solid}, meskipun kadang perlu lebih tegas',
        '{Mampu|Sanggup|Bisa} mendengarkan {dan|serta} mempertimbangkan input dari tim',
        'Cukup percaya diri dalam mengambil keputusan',
        '{Memiliki|Mempunyai} visi yang jelas meski kadang perlu lebih detail',
        'Dapat membangun hubungan baik dengan anggota tim',
        'Berani mengambil inisiatif dalam situasi tertentu',
        'Cukup konsisten dalam tindakan {dan|serta} keputusan'
      ],
      suggestions: [
    ...
    },
    {
      ...
      description: 'Anda memiliki potensi kepemimpinan yang bisa dikembangkan. Saat ini kemampuan kepemimpinan Anda belum cukup kuat untuk memimpin kelompok besar, namun dengan pembelajaran {dan|serta} latihan yang tepat, Anda bisa berkembang menjadi pemimpin {yang baik|yang mumpuni|yang solid}.',
      characteristics: [
        ...
        '{Memiliki|Mempunyai} ide bagus tapi kesulitan mengeksekusi',
        '{Kurang|Belum cukup} berani mengambil inisiatif atau tanggung jawab besar',
        'Masih perlu belajar cara mempengaruhi {dan|serta} memotivasi orang lain',
    ...
    },
    {
      ...
      description: 'Kepemimpinan bukanlah bakat alami Anda saat ini. Anda cenderung pasif, kurang percaya diri, atau merasa cemas dalam situasi kepemimpinan. Namun jangan khawatir - kepemimpinan adalah skill yang bisa dipelajari! Dengan komitmen {dan|serta} usaha yang tepat, Anda bisa berkembang.',
      characteristics: [
        '{Sangat|Amat} pasif dalam kelompok atau organisasi',
        'Kesulitan berkomunikasi dengan jelas {dan|serta} tegas',
        '{Kurang|Belum cukup} percaya diri dalam mengambil keputusan',
        '{Cenderung|Umumnya|Kerap} menghindari tanggung jawab kepemimpinan',
        'Merasa cemas atau tidak nyaman saat harus memimpin',
        '{Lebih suka|Lebih senang|Lebih memilih} mengikuti daripada memimpin',
  ...
  const GAYA_KEPEMIMPINAN_STYLES = [
    {
      ...
      desc: 'Anda adalah pemimpin yang menghargai potensi setiap individu {dan|serta} mengutamakan koordinasi serta bimbingan tim. Keputusan dibuat bersama-sama dengan melibatkan masukan dari anggota tim.',
      characteristics: [
        'Mendengarkan {dan|serta} menghargai pendapat semua anggota tim',
      ...
      strengths: [
        'Meningkatkan motivasi {dan|serta} kepuasan tim',
        'Keputusan lebih berkualitas karena berbagai perspektif',
        'Membangun rasa memiliki {dan|serta} tanggung jawab bersama',
        'Mengembangkan kemampuan problem-solving tim',
        'Menciptakan lingkungan kerja yang positif {dan|serta} inklusif'
      ],
      weaknesses: [
        ...
        'Membutuhkan tim yang mature {dan|serta} bertanggung jawab',
        'Risiko kehilangan kontrol jika tidak dikelola baik'
      ]
    },
    {
      id: 'oto', name: 'Otokratis', color: '#e74c3c', icon: '👊',
      desc: 'Keputusan mutlak ada di tangan Anda. Anda fokus pada kepatuhan {dan|serta} aturan yang Anda rancang sendiri. Kontrol penuh terhadap proses kerja adalah prioritas Anda.',
      characteristics: [
      ...
      strengths: [
        'Pengambilan keputusan sangat cepat {dan|serta} efisien',
        'Efektif dalam situasi krisis atau emergency',
        'Kontrol penuh memastikan konsistensi output',
        'Jelas {dan|serta} tidak ambigu dalam ekspektasi',
        'Cocok untuk tim yang kurang berpengalaman'
      ],
      weaknesses: [
        'Mengurangi kreativitas {dan|serta} inisiatif tim',
    ...
    },
    {
      ...
      strengths: [
        'Mendorong kreativitas {dan|serta} inovasi maksimal',
        'Cocok untuk tim expert {dan|serta} self-motivated',
    ...
    },
    {
      ...
      desc: 'Anda cenderung melindungi anggota tim {dan|serta} menganggap mereka perlu bimbingan penuh, layaknya hubungan orang tua dengan anak. Anda memberikan arahan yang jelas dan peduli terhadap kesejahteraan tim.',
      characteristics: [
        'Memberikan perlindungan {dan|serta} perhatian personal',
        ...
        'Memberikan arahan detail {dan|serta} bimbingan konstan'
      ],
      strengths: [
        'Menciptakan rasa aman {dan|serta} kekeluargaan',
      ...
      weaknesses: [
        'Menghambat kemandirian {dan|serta} pertumbuhan tim',
        'Dependensi berlebihan pada pemimpin',
        'Bisa dianggap condescending atau meremehkan',
        'Keputusan tidak selalu objektif',
        '{Sulit|Susah|Berat} memisahkan hubungan personal {dan|serta} profesional'
      ]
    }
  ];
  ...
  const MOTIVASI_LEVELS = [
    {
      ...
      description: 'Luar biasa! Anda menunjukkan motivasi yang kuat untuk menjadi pemimpin, adanya sikap ideal yang diperlukan untuk memimpin {dan|serta} mengorganisasikan sesuatu. Anda berbakat menjadi pemimpin {yang baik|yang mumpuni|yang solid}.',
      factors: [
    ...
    },
    {
      ...
      description: 'Anda menunjukkan keragu-raguan untuk menjadi pemimpin. Bersikaplah tegas, mandiri, {dan|serta} lebih bertanggungjawab. Di satu sisi Anda tertarik untuk memimpin, namun di sisi lain masih ada keraguan dan ketidakpastian.',
      factors: [
    ...
    },
    {
      ...
      description: 'Saat ini Anda menunjukkan motivasi yang rendah untuk menjadi pemimpin. Perlu mengembangkan karakteristik {dan|serta} belajar menjadi pemimpin, jangan hanya puas menjadi bawahan dengan tugas yang biasa saja.',
      factors: [
  ...
  const MANWAK_LEVELS = [
    {
      ...
      description: 'Hasil jawaban yang diisikan bukanlah diri yang sebenarnya. Skor terlalu sempurna {dan|serta} tidak realistis. Untuk mendapatkan hasil yang bermakna, cobalah lebih jujur dalam menilai kebiasaan manajemen waktu Anda.',
    ...
    },
    {
      ...
      description: 'Kamu benar-benar unggul, luar biasa prima! Kamu adalah pengelola waktu yang sangat luar biasa. Kemampuan Anda dalam memprioritaskan, merencanakan, {dan|serta} melaksanakan tugas patut diacungi jempol.',
      warning: null,
      aspects: [
    ...
    },
    {
      ...
      description: '{Sangat|Amat} baik! Kamu dapat membuat skala prioritas {dan|serta} kebijaksanaan dalam mengelola waktu dengan baik. Anda memiliki sistem yang efektif untuk mengorganisir tugas dan tanggung jawab.',
      warning: null,
      aspects: [
    ...
    },
    {
      ...
      description: 'Berpikirlah untuk mulai mengelola waktu dengan baik agar setiap waktu tidak terbuang percuma {dan|serta} bisa memanfaatkan waktu dengan lebih baik lagi.',
      warning: null,
      aspects: [
  ...
  const STRES_LEVELS = [
    {
      ...
      description: 'Hasil tes menunjukkan bahwa Anda sedang mengalami stres negatif yang cukup signifikan. Kondisi ini tidak boleh diabaikan karena dapat berdampak pada kesehatan fisik {dan|serta} mental Anda dalam jangka panjang. Anda perlu segera mengambil langkah-langkah untuk mengelola dan mengurangi stres.',
    ...
    },
    {
      ...
      description: 'Selamat! Anda masih berada dalam kondisi yang aman dalam mengelola stres di tempat kerja. Anda memiliki coping mechanism yang cukup baik {dan|serta} mampu menjaga keseimbangan antara tuntutan pekerjaan dengan wellbeing pribadi. Pertahankan kondisi ini dengan terus merawat kesehatan mental Anda.',
      warning: null,
      indicators: [
    ...
    levels: [
      {
        ...
        description: 'Anda memiliki tingkat keberanian yang sangat tinggi! Anda tidak mudah menyerah menghadapi tantangan {dan|serta} berani mengambil risiko yang terukur. Anda adalah tipe orang yang bisa diandalkan dalam situasi sulit.',
        traits: [
          'Berani mengambil keputusan di bawah tekanan',
          'Tidak mudah dipengaruhi oleh rasa takut',
          '{Mampu|Sanggup|Bisa} keluar dari zona nyaman dengan percaya diri',
          'Gigih {dan|serta} pantang menyerah menghadapi rintangan'
        ],
        suggestions: [
      ...
      },
      {
        ...
        description: 'Anda memiliki keberanian yang cukup baik dalam menghadapi berbagai situasi. {Terkadang|Kadang|Kadang-kadang} rasa takut masih mempengaruhi keputusan Anda, namun secara umum Anda mampu melewati tantangan dengan baik.',
        traits: [
          'Berani dalam situasi yang sudah familiar',
          'Masih perlu dorongan dalam situasi yang benar-benar baru',
          '{Memiliki|Mempunyai} kemampuan {yang baik|yang mumpuni|yang solid} dalam mengelola kecemasan',
      ...
      },
      {
        ...
        description: 'Saat ini rasa takut cukup mempengaruhi langkah Anda. Ini bukan sesuatu yang permanen - keberanian adalah skill yang bisa dipelajari {dan|serta} dikembangkan dengan latihan yang tepat dan konsisten.',
        traits: [
          '{Cenderung|Umumnya|Kerap} menghindari situasi yang tidak nyaman',
