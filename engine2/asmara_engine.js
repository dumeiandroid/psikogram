    ...
    '09': {
      ...
      types: {
        A: {
          ...
          color: '#c0392b',
          icon: '👮',
          description: 'Pola asuh dengan aturan yang ketat {dan|serta} kepatuhan tinggi. Orangtua sangat menuntut tetapi kurang responsif terhadap kebutuhan anak.',
          characteristics: [
            'Aturan yang sangat ketat {dan|serta} tidak fleksibel',
        ...
        B: {
          ...
          characteristics: [
            ...
            'Kehangatan {dan|serta} responsif terhadap kebutuhan anak',
        ...
        C: {
          ...
          color: '#f39c12',
          icon: '🎈',
          description: 'Pola asuh dengan sedikit batasan {dan|serta} aturan. Orangtua sangat responsif tetapi kurang menuntut, memberikan kebebasan tinggi pada anak.',
          characteristics: [
            'Aturan yang sangat sedikit atau tidak ada',
            'Orangtua lebih seperti teman',
            'Tidak konsisten dalam disiplin',
            'Menghindari konfrontasi',
            '{Sangat|Amat} hangat {dan|serta} menerima',
    ...
    '12': {
      ...
      types: {
        A: {
          ...
          color: '#ff4757',
          icon: '💕',
          description: 'Anda menghargai hubungan yang penuh perasaan, kenangan indah, {dan|serta} kedekatan emosional yang mendalam.',
          characteristics: [
            'Mengutamakan kualitas waktu bersama',
            'Menghargai gesture romantis {dan|serta} kejutan',
            'Senang berbagi perasaan {dan|serta} pikiran intim',
          ...
          tips: [
            ...
            'Ingat {dan|serta} rayakan moment penting'
          ]
        },
        B: {
          name: 'DOMESTIK',
          color: '#2ed573',
          icon: '🏡',
          description: 'Anda menunjukkan cinta melalui tindakan praktis, pelayanan, {dan|serta} menciptakan kenyamanan di rumah.',
          characteristics: [
            'Cinta melalui tindakan, bukan kata',
            'Menciptakan kenyamanan rumah',
            'Memasak {dan|serta} merawat pasangan',
            'Melayani kebutuhan praktis pasangan',
            'Menghargai rutinitas {dan|serta} stabilitas',
            'Membangun kehidupan bersama'
          ],
          strengths: [
            'Dapat diandalkan',
            'Praktis {dan|serta} supportif',
        ...
        C: {
          ...
          color: '#ffa502',
          icon: '✈️',
          description: 'Anda menunjukkan cinta melalui pengalaman baru, petualangan, {dan|serta} kejutan yang menyenangkan.',
          characteristics: [
            'Cinta melalui pengalaman bersama',
            'Menyukai tantangan {dan|serta} hal baru',
            'Spontan {dan|serta} penuh kejutan',
          ...
          strengths: [
            ...
            'Selalu ada hal baru',
            'Spontanitas',
            'Kegembiraan {dan|serta} antusiasme'
          ],
          ideal_partner: [
          ...
          tips: [
            'Rencanakan kejutan {dan|serta} aktivitas baru',
            '{Coba|Cobalah} hal-hal baru bersama',
        ...
        D: {
          ...
          color: '#5352ed',
          icon: '👑',
          description: 'Anda menghargai kualitas, kemewahan, {dan|serta} menunjukkan cinta melalui pemberian dan perhatian yang berkelas.',
          characteristics: [
            'Menghargai kualitas di atas kuantitas',
            'Cinta ditunjukkan lewat pemberian',
            'Menghargai kemewahan {dan|serta} estetika',
            'Perhatian pada detail {dan|serta} penampilan',
          ...
          tips: [
            ...
            'Jaga penampilan {dan|serta} presentasi',
    ...
    '13': {
      ...
      types: {
        Eros: {
          ...
          color: '#d63031',
          icon: '❤️‍🔥',
          description: 'Anda adalah tipe pecinta yang sangat romantis {dan|serta} penuh gairah. Ketertarikan fisik dan kimia emosional sangat penting bagi Anda dalam menjalin hubungan.',
          characteristics: [
            '{Sangat|Amat} mementingkan chemistry {dan|serta} ketertarikan fisik',
            '{Mudah|Gampang} jatuh cinta {dan|serta} merasakan perasaan yang intens',
            'Menghargai momen-momen romantis {dan|serta} keintiman',
            '{Cenderung|Umumnya|Kerap} idealis dalam memandang cinta'
          ],
          advice: [
        ...
        Ludus: {
          ...
          color: '#e17055',
          icon: '🎭',
          description: 'Anda memandang cinta sebagai permainan yang menyenangkan {dan|serta} petualangan. Anda menikmati kebebasan dan tidak terburu-buru untuk terikat dalam komitmen serius.',
          characteristics: [
            'Menganggap cinta sebagai sesuatu yang menyenangkan {dan|serta} bebas',
            '{Tidak suka|Kurang suka|Enggan} terikat komitmen yang terlalu serius',
            'Menikmati proses mengenal banyak orang',
            '{Cenderung|Umumnya|Kerap} menghindari drama {dan|serta} konflik emosional'
          ],
          advice: [
        ...
        Storge: {
          ...
          color: '#00b894',
          icon: '🤗',
          description: 'Cinta Anda tumbuh dari fondasi persahabatan yang kuat. Anda membangun hubungan secara bertahap berdasarkan kepercayaan, kesamaan, {dan|serta} kenyamanan bersama.',
          characteristics: [
            'Hubungan dimulai dari persahabatan yang mendalam',
            'Mengutamakan kenyamanan {dan|serta} kepercayaan',
            'Cinta berkembang secara perlahan {dan|serta} alami',
            'Menghargai kebersamaan {dan|serta} kebiasaan bersama'
          ],
          advice: [
        ...
        Pragma: {
          ...
          color: '#6c5ce7',
          icon: '📋',
          description: 'Anda adalah tipe yang praktis {dan|serta} logis dalam memilih pasangan. Anda mempertimbangkan berbagai faktor seperti kecocokan nilai, tujuan hidup, dan kompatibilitas jangka panjang.',
          characteristics: [
            'Memilih pasangan berdasarkan kriteria yang jelas',
            'Mengutamakan kecocokan nilai, latar belakang, {dan|serta} tujuan',
            'Berpikir jangka panjang dalam hubungan',
            'Realistis {dan|serta} rasional dalam memandang cinta'
          ],
          advice: [
        ...
        Mania: {
          ...
          color: '#e74c3c',
          icon: '😰',
          description: 'Anda mengalami cinta dengan intensitas yang sangat tinggi, seringkali diwarnai dengan perasaan cemburu, posesif, {dan|serta} ketergantungan emosional yang kuat pada pasangan.',
          characteristics: [
            'Merasakan cinta dengan sangat intens {dan|serta} mendalam',
            '{Cenderung|Umumnya|Kerap} cemburu {dan|serta} membutuhkan banyak perhatian',
            '{Sering|Kerap|Acap kali} merasa insecure dalam hubungan',
        ...
        Agape: {
          ...
          characteristics: [
            '{Sangat|Amat} peduli {dan|serta} penuh kasih sayang',
            'Rela berkorban demi kebahagiaan pasangan',
            'Mencintai tanpa mengharapkan balasan',
            '{Sangat|Amat} setia {dan|serta} komit dalam hubungan'
          ],
          advice: [
    ...
    '14': {
      ...
      types: {
        high: {
          ...
          color: '#d63031',
          typeClass: 'type-A',
          description: 'Kamu mulai terikat dalam satu hubungan, berhati-hatilah. {Coba|Cobalah} kembalikan fokus dari tujuan hubungan tersebut. {Jangan|Hindari untuk} terlalu bergantung pada hubungan tersebut karena hubungan yang terlalu mengikat {dan|serta} menjadi candu akan merugikan kedua belah pihak.',
          characteristics: [
            'Merasa sangat bergantung pada pasangan',
            '{Sulit|Susah|Berat} membayangkan hidup tanpa hubungan ini',
            'Hubungan menjadi pusat dari segalanya',
            '{Cenderung|Umumnya|Kerap} mengabaikan kebutuhan pribadi demi hubungan',
        ...
        mid: {
          ...
          color: '#27ae60',
          typeClass: 'type-B',
          description: 'Kamu merasa membutuhkan sebuah hubungan, tapi tidak mau memaksakan sebuah hubungan. Cukup ideal dalam membina sebuah hubungan {yang baik|yang mumpuni|yang solid} karena hubungan yang ideal adalah hubungan yang saling membangun tanpa harus ada pengekangan.',
          characteristics: [
            'Membutuhkan hubungan tapi tidak memaksakan',
            'Saling membangun tanpa pengekangan',
            '{Memiliki|Mempunyai} kemandirian dalam hubungan',
            'Komunikasi yang terbuka {dan|serta} sehat',
        ...
        low: {
          ...
          color: '#f39c12',
          typeClass: 'type-C',
          description: 'Kamu menganggap hubungan hanya sebatas pelengkap, status, {dan|serta} tidak terlalu penting dalam menjalaninya. Kamu bisa terlepas dari hubungannya dan cenderung tidak serius dalam menjalani hubungan tersebut.',
          characteristics: [
            'Hubungan dianggap hanya sebagai pelengkap',
            'Tidak terlalu mementingkan status hubungan',
            '{Cenderung|Umumnya|Kerap} tidak serius dalam menjalani hubungan',
            '{Mudah|Gampang} terlepas dari hubungan',
            '{Kurang|Belum cukup} investasi emosional dalam hubungan'
          ],
          advice: [
    ...
    '15': {
      ...
      types: {
        excellent: {
          ...
          description: 'Kamu memiliki kekuatan dalam hubungan dengan pasangan kamu. Bisa dikatakan, kamu cukup dekat dengan pasangan {dan|serta} mengenalnya cukup baik. Selamat! Hubungan kamu berpotensi terus stabil dan membahagiakan.',
          characteristics: [
            '{Memiliki|Mempunyai} pemahaman mendalam tentang kehidupan inner pasangan',
            'Mengetahui mimpi, harapan, {dan|serta} ketakutan pasangan',
            'Sadar akan stres, kekhawatiran, {dan|serta} kebahagiaan pasangan',
            'Memahami nilai-nilai hidup {dan|serta} prioritas pasangan',
            'Mengenal sejarah hidup {dan|serta} pengalaman penting pasangan',
            'Tahu tentang teman, keluarga, {dan|serta} relasi sosial pasangan'
          ],
          strengths: [
            'Komunikasi yang sangat baik {dan|serta} terbuka',
            'Empati {dan|serta} pemahaman emosional yang tinggi',
        ...
        good: {
          ...
          weaknesses: [
            '{Kurang|Belum cukup} pengetahuan tentang kehidupan inner pasangan',
            'Belum memahami sepenuhnya mimpi {dan|serta} ketakutan pasangan',
        ...
        needsWork: {
          ...
          description: 'Hubungan kamu sedang dalam masalah. Hanya satu cara untuk membuat hubungan kamu stabil {dan|serta} membahagiakan — berusahalah memperbaikinya. Kenali pasangan dengan lebih baik. Semakin kamu mengenal pasangan, semakin mudah bagi kamu untuk membangun hubungan yang membahagiakan.',
          characteristics: [
            ...
            'Jarang berbicara tentang perasaan {dan|serta} pikiran pribadi',
          ...
          weaknesses: [
            ...
            'Kurangnya empati {dan|serta} pemahaman mendalam',
    ...
    '16': {
      ...
      types: {
        adventurous: {
          ...
          description: 'Kamu termasuk gampang terjerumus dalam lubang perselingkuhan. {Jangan|Hindari untuk}-jangan tanpa menyadarinya, kamu merupakan tipe petualang cinta? Saat dilanda kebosanan, mencari sosok lain yang bisa memberi perhatian {dan|serta} tidak pernah menyia-nyiakan kesempatan yang datang. Ada seseorang yang menarik tak segan untuk berkenalan dan berhubungan lebih lanjut. Hati-hati, meski awalnya hanya teman dekat, bukan tidak mungkin hubungan kamu akan semakin jauh dan dalam. Akan bijaksana bila kamu mulai menjaga jarak saat berhubungan dengan lawan jenis. Pikirkanlah pentingnya keutuhan kamu dengan pasangan.',
          characteristics: [
            '{Mudah|Gampang} bosan dalam rutinitas hubungan',
            'Terbuka terhadap perhatian dari lawan jenis',
            '{Cenderung|Umumnya|Kerap} mencari validasi dari luar hubungan',
            '{Kurang|Belum cukup} puas dengan monotoni dalam hubungan',
        ...
        loyal: {
          ...
          characteristics: [
            '{Memiliki|Mempunyai} komitmen yang kuat terhadap hubungan',
            '{Mampu|Sanggup|Bisa} membedakan antara persahabatan {dan|serta} romansa',
          ...
          risks: null,
          strengths: [
            'Balance antara kesetiaan {dan|serta} kehidupan sosial',
            'Kepercayaan diri dalam hubungan',
            'Komunikasi {yang baik|yang mumpuni|yang solid} dengan pasangan',
            'Boundaries yang jelas namun tidak berlebihan',
            '{Mampu|Sanggup|Bisa} mempertahankan hubungan jangka panjang'
          ],
          weaknesses: null,
          advice: [
        ...
        rigid: {
          ...
          color: '#2ecc71',
          colorClass: 'rigid',
          description: 'Kamu memang tidak gampang tertarik pada lawan jenis. Risiko perselingkuhan kamu juga sangat kecil. Hanya, hati-hati dengan jalinan relasi, baik dengan teman, rekan kerja, atau atasan bisa terganggu. Kamu dianggap sebagai orang yang tidak menyenangkan. Basa-basi sangat jauh dari kehidupan kamu. Kamu juga menganggap segala sesuatu dengan hitam putih. {Jangan|Hindari untuk} heran, jika banyak teman kamu akan beringsut, teman-teman kantor juga akan ogah mendekati kamu. Bagi mereka, kamu termasuk sosok yang tidak asyik diajak berteman.',
          characteristics: [
            'Prinsip kesetiaan yang sangat kuat {dan|serta} tidak tergoyahkan',
            '{Cenderung|Umumnya|Kerap} berpikir hitam-putih tanpa grey area',
            '{Sangat|Amat} hati-hati bahkan dalam interaksi biasa dengan lawan jenis',
            'Mungkin menghindari situasi sosial untuk menghindari kesalahpahaman',
            'Standar moral yang sangat tinggi untuk diri sendiri {dan|serta} orang lain',
          ...
          weaknesses: [
            ...
            '{Kurang|Belum cukup} fleksibel dalam situasi sosial normal'
          ],
          advice: [
    ...
    '17': {
      ...
      types: {
        sahabat: {
          ...
          color: '#6c5ce7',
          icon: '🌟',
          description: 'Kamu adalah seorang sahabat {yang baik|yang mumpuni|yang solid}. Kamu memiliki sikap saling membangun, pengertian, {dan|serta} kebaikan. Sahabat kamu adalah orang yang beruntung karena bisa mengenal kamu. Dalam hubungannya, kamu menjadi magnet yang membuat persahabatan tampak menjadi ideal dan saling membutuhkan. Selamat!',
          characteristics: [
            '{Memiliki|Mempunyai} sikap saling membangun yang luar biasa',
            'Penuh pengertian {dan|serta} kebaikan kepada sahabat',
            'Menjadi magnet positif dalam persahabatan',
            'Membuat persahabatan terasa ideal {dan|serta} saling membutuhkan',
            'Loyal {dan|serta} setia dalam segala kondisi',
            'Menghargai {dan|serta} mendukung pencapaian sahabat'
          ],
          suggestions: [
        ...
        biasa: {
          ...
          color: '#fab1a0',
          icon: '🤝',
          description: 'Kamu termasuk teman {yang baik|yang mumpuni|yang solid}, tapi belum bisa dikatakan sebagai sahabat. Ada beberapa hal yang menjadikan kedekatan kamu {dan|serta} seorang temanmu dikatakan masih memiliki batasan tertentu. Perhatian, keterbukaan, dan kepercayaan yang kamu miliki masih dalam kadar yang biasa saja.',
          characteristics: [
            '{Memiliki|Mempunyai} niat baik dalam berteman',
    ...
    '18': {
      ...
      types: {
        ideal: {
          ...
          color: '#27ae60',
          icon: '💚',
          description: 'Kalian adalah pasangan yang cukup ideal, kalian memiliki kemandirian, saling percaya {dan|serta} orientasi {yang baik|yang mumpuni|yang solid} dalam menjalin sebuah hubungan. Jika diteruskan dan dikenalkan lebih jauh lagi, bisa jadi kamu dan pendampingmu menjadi pasangan yang baik.',
          warning: null,
          indicators: [
        ...
        cukup: {
          ...
          color: '#f39c12',
          icon: '⭐',
          description: 'Kamu {dan|serta} pasanganmu adalah pasangan yang cukup baik. Kalian memiliki beberapa fondasi {yang baik|yang mumpuni|yang solid} namun masih ada ruang untuk berkembang lebih jauh lagi dalam hubungan.',
        ...
        kurang: {
          ...
          color: '#e74c3c',
          icon: '⚠️',
          description: 'Kamu {dan|serta} pasanganmu masih kurang memiliki kedekatan. Ada beberapa hal yang wajib dimiliki pasangan yang tidak kalian miliki — kurang adanya kepercayaan, kejujuran, dan kedekatan secara pribadi. Hal inilah yang akan menjadi penghambat dalam hubungan kalian nantinya.',
